...
class CardioZone__CardioType(object):
    #TODO just amend all these values together to the initial objects

    # cardiozone_id, cardiotype_id
    VALUES = (
        (8, 2),
        (2, 1),
        (6, 5),
...
class CardioZone__FitnessLevel(object):
    # cardiozone_id, fitnesslevel_id
    VALUES = (
        (10, 2),
        (12, 1),
        (2, 1),
